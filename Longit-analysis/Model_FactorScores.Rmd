...
# raw composite sum (used in plot below)
comp = rawdat %>%
  dplyr::select(REP1:RIT10) %>%
  rowSums
dat$comp_items = comp
...
p3
# ggsave(plot = p3, filename=  '/Users/sifre002/Box/sifre002/11_Figures/Longit_RBS_MS/rephistograms.jpg', height = 6.5, width = 6)
...
p3 = gridExtra::grid.arrange(p1, p2, nrow = 2)
p3
# ggsave(plot = p3, filename=  '/Users/sifre002/Box/sifre002/11_Figures/Longit_RBS_MS/selfhistograms.jpg', height = 6.5, width = 6)
...
p3 = gridExtra::grid.arrange(p1, p2, nrow = 2)
p3
# ggsave(plot = p3, filename=  '/Users/sifre002/Box/sifre002/11_Figures/Longit_RBS_MS/higherorderhitograms.jpg', height = 6.5, width = 6)
